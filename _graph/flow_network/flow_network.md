...
![pic_01](/assets/images/graph/flow_network/network_flow_1.png){:height="250pt"}
...
![pic_02](/assets/images/graph/flow_network/flow_net_augment_path_case_1.png){:height="130pt"} \\
Case 2: $$ f(x,v) - \alpha + \sum_{x^{‘} \neq x}f(x^{‘},v) = f(v,y) - \alpha + \sum_{y^{‘} \neq y}f(v, y^{‘}) $$ – conserved \\
![pic_03](/assets/images/graph/flow_network/flow_net_augment_path_case_2.png){:height="130pt"} \\
